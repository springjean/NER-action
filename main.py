...
#配置相关
flags.DEFINE_integer('seg_dim', 0, 'seg embedding size')
flags.DEFINE_integer('word_dim', 300, 'word embedding')#词向量是50维
...
flags.DEFINE_integer('max_epoch', 50, '最大轮训次数')
...
flags.DEFINE_string('emb_file', os.path.join('data', 'sgns.wiki.word'), '词向量文件路径')#词向量是wiki_50-bigram.utf8
